...
const MemberPage: React.FC = () => {
    ...
    const { Firstname, Lastname, logo, address, phone, email, website, iframe, aboutus, sectionItem1, sectionItem2, sectionItem3, sectionItem4, sectionItem5, type } = member;
    ...
    const services = [
        ...
        { icon: IoCheckmarkCircle, description: `${sectionItem4}` },
        { icon: IoCheckmarkCircle, description: `${sectionItem5}` }
    ...
    return (
        <div className="flex flex-col items-center w-full space-y-2">
            ...
            <div className="w-full max-w-8xl bg-white rounded-lg shadow-xl">
                <Contact ccEmail={email} name={Firstname} />
            </div>
        </div>
    );
};
