...
const MemberPage: React.FC = () => {
    const memberId = '80'; // Manually set the ID here for each page
    ...
    const { Firstname, Lastname, logo, address, phone, type, email, website, iframe, aboutus, sectionItem1, sectionItem2, sectionItem3 } = member;
