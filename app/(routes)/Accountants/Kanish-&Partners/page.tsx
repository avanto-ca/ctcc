...
const MemberPage: React.FC = () => {
    const memberId = '18'; // Manually set the ID here for each page
    ...
    const { Firstname, Lastname, logo, address, phone, email, website, iframe, aboutus, sectionItem1, sectionItem2, sectionItem3, Name, type } = member;
